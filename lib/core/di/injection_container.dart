...
Future<void> init() async {
  ...
  // Repository
  sl.registerLazySingleton<MembroRepository>(
    () => MembroRepositoryImpl(sl()),
  );

  // Datasource
  sl.registerLazySingleton<MembroDatasource>(
    () => MembroDatasourceImpl(),
  );
  ...
  // Datasource
  sl.registerLazySingleton<ConsultaDatasource>(
    () => ConsultaDatasourceImpl(),
  );
  ...
  // Registra AuthBloc no GetIt para que possa ser usado com Get.find
  sl.registerFactory(() => sl<AuthBloc>());
}
