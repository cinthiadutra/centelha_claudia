    ...
    return BlocProvider(
      ...
      child: GetMaterialApp(
        ...
        getPages: [
          ...
          GetPage(name: '/membros/incluir', page: () => const IncluirMembroPage()),
          GetPage(name: '/membros/pesquisar', page: () => const PesquisarMembroPage()),
          GetPage(name: '/membros/editar', page: () => const EditarMembroPage()),
          GetPage(name: '/membros/relatorios', page: () => const RelatoriosMembroPage()),
          GetPage(name: '/consultas/nova', page: () => const NovaConsultaPage()),
          GetPage(name: '/consultas/pesquisar', page: () => const PesquisarConsultaPage()),
