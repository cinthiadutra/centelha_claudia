...
class GerenciarGrupoTrabalhoEspiritualPage extends StatefulWidget {
  ...
  @override
  State<GerenciarGrupoTrabalhoEspiritualPage> createState() => _GerenciarGrupoTrabalhoEspiritualPageState();
}

class _GerenciarGrupoTrabalhoEspiritualPageState extends State<GerenciarGrupoTrabalhoEspiritualPage> {
  ...
  void _buscarMembro() async {
    ...
    grupoTrabalhoAtual = await grupoTrabalhoEspiritualController.buscarPorCadastro(numero);
    ...
    setState(() {
      ...
      if (grupoTrabalhoAtual != null) {
        atividadeEspiritualSelecionada = grupoTrabalhoAtual!.atividadeEspiritual;
  ...
  void _atualizarGruposDisponiveis() {
    if (atividadeEspiritualSelecionada != null) {
      setState(() {
        gruposDisponiveis = GrupoTrabalhoEspiritualConstants.getGruposPorAtividade(
          atividadeEspiritualSelecionada!,
        );
        
        // Se o grupo atual não pertence à nova atividade, limpa a seleção
        if (grupoTrabalhoSelecionado != null && !gruposDisponiveis.contains(grupoTrabalhoSelecionado)) {
          grupoTrabalhoSelecionado = null;
        }
      });
    } else {
  ...
  void _salvar() async {
    ...
    if (atividadeEspiritualSelecionada == null || grupoTrabalhoSelecionado == null || funcaoSelecionada == null) {
      Get.snackbar(
        'Atenção',
  ...
  void _excluir() async {
    ...
    if (confirma == true) {
      await grupoTrabalhoEspiritualController.remover(grupoTrabalhoAtual!.numeroCadastro);
      _limparFormulario();
    }
  }
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: statusAtivo ? Colors.green.shade50 : Colors.orange.shade50,
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(
                                      fontSize: 16,
                                      fontWeight: FontWeight.bold,
                                      color: statusAtivo ? Colors.green.shade900 : Colors.orange.shade900,
                                    ),
                                  ),
                                  if (!statusAtivo) ...[
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        DropdownButtonFormField<String>(
                          value: atividadeEspiritualSelecionada,
                          decoration: const InputDecoration(
                            labelText: 'Atividade Espiritual *',
                            border: OutlineInputBorder(),
                          ),
                          items: GrupoTrabalhoEspiritualConstants.atividadesOpcoes.map((atividade) {
                        ...
                        const SizedBox(height: 16),
                        DropdownButtonFormField<String>(
                          value: grupoTrabalhoSelecionado,
                          ...
                          onChanged: atividadeEspiritualSelecionada == null
                              ? null
                              : (v) => setState(() => grupoTrabalhoSelecionado = v),
                        ),
                        const SizedBox(height: 16),
                        DropdownButtonFormField<String>(
                          ...
                          items: GrupoTrabalhoEspiritualConstants.funcoesOpcoes.map((funcao) {
                            return DropdownMenuItem<String>(
                              value: funcao,
                              child: Text(funcao),
                            );
