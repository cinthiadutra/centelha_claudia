...
class MembroModel extends Membro {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'desistenciaPrimeiroEstagio':
          desistenciaPrimeiroEstagio?.toIso8601String(),
      ...
      'condicaoSegundoEstagio': condicaoSegundoEstagio,
      ...
      'condicaoTerceiroEstagio': condicaoTerceiroEstagio,
      'inicioTerceiroEstagio': inicioTerceiroEstagio?.toIso8601String(),
      'desistenciaTerceiroEstagio':
          desistenciaTerceiroEstagio?.toIso8601String(),
      ...
      'condicaoQuartoEstagio': condicaoQuartoEstagio,
      ...
      'observacoesOrixa': observacoesOrixa,
  ...
  factory MembroModel.fromEntity(Membro membro) {
    return MembroModel(
      ...
      justificativaSegundoDesligamento:
          membro.justificativaSegundoDesligamento,
