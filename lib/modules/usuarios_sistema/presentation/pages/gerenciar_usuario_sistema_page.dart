...
class GerenciarUsuarioSistemaPage extends StatefulWidget {
  ...
  @override
  State<GerenciarUsuarioSistemaPage> createState() =>
      _GerenciarUsuarioSistemaPageState();
}

class _GerenciarUsuarioSistemaPageState
    extends State<GerenciarUsuarioSistemaPage> {
                    ...
                    children: [
                      ...
                      DropdownButtonFormField<int>(
                        ...
                        items: const [
                          DropdownMenuItem(
                            value: 1,
                            child: Text('Nível 1 - Acesso próprio'),
                          ),
                          DropdownMenuItem(
                            value: 2,
                            child: Text('Nível 2 - Secretaria'),
                          ),
                          DropdownMenuItem(
                            value: 3,
                            child: Text('Nível 3 - Líder espiritual'),
                          ),
                          DropdownMenuItem(
                            value: 4,
                            child: Text('Nível 4 - Administrador'),
                          ),
                        ],
                        onChanged: (v) =>
                            setState(() => nivelPermissaoSelecionado = v),
                      ),
                      const SizedBox(height: 16),
                            ...
                            subtitle: Column(
                              ...
                              children: [
                                ...
                                Chip(
                                  ...
                                  backgroundColor: _getNivelColor(
